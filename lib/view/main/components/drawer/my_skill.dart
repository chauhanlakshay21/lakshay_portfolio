  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.85, title: 'SQL',image: 'assets/icons/dart.png'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.5, title: 'Java',image: 'assets/icons/java.png'),
      ],);
  }
}
