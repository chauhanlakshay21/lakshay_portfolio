...
class SocialMediaIconColumn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        SocialMediaIcon(icon: 'assets/icons/linkedin.svg',onTap: ()=>launchUrl(Uri.parse('www.linkedin.com/in/lakshay-chauhan-632605271'))),
        SocialMediaIcon(icon: 'assets/icons/github.svg',onTap: () => launchUrl(Uri.parse('https://github.com/chauhanlakshay21')),),
